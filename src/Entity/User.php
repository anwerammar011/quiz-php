...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Answers::class, inversedBy="users")
     */
    private $user;
    ...
    public function setAccountCreatedAt(\DateTimeImmutable $account_created_at): self
    {
    ...
    public function addUser(Answers $user): self
    {
    ...
    public function removeUser(Answers $user): self
    {
